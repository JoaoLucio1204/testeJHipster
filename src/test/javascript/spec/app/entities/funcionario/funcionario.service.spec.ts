    ...
    describe('Funcionario Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Funcionario', () => {
                service.create(new Funcionario(null)).subscribe(received => {
            ...
            it('should update a Funcionario', () => {
                service.update(new Funcionario(123)).subscribe(received => {
            ...
            it('should return a Funcionario', () => {
