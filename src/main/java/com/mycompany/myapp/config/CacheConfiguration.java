...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Empresa.class.getName() + ".funcionarios", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Funcionario.class.getName(), jcacheConfiguration);
